...
builder.Configuration.AddModuleConfiguration(["sample", "orders", "organization", "customer", "inventory", "sales"], builder.Environment.EnvironmentName);
...
builder.Services
    .AddSampleModule(builder.Configuration, builder.Environment, databaseConnectionString)
    .AddOrdersModule(builder.Configuration, builder.Environment, databaseConnectionString)
    .AddOrganizationModule(builder.Configuration, builder.Environment, databaseConnectionString)
    .AddCustomerModule(builder.Configuration, builder.Environment, databaseConnectionString)
    .AddInventoryModule(builder.Configuration, builder.Environment, databaseConnectionString)
