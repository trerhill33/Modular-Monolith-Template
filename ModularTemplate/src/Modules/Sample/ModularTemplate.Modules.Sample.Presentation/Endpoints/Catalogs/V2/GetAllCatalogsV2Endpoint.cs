...
using ModularTemplate.Modules.Sample.Application.Catalogs.GetCatalogs;
using ModularTemplate.Modules.Sample.Application.Features;

namespace ModularTemplate.Modules.Sample.Presentation.Endpoints.Catalogs.V2;
...
internal sealed class GetAllCatalogsV2Endpoint : IEndpoint
{
    public void MapEndpoint(RouteGroupBuilder group)
    {
        group.MapGet("/", GetAllCatalogsAsync)
            ...
            .RequireFeature(SampleFeatures.CatalogV2Pagination);
    }
