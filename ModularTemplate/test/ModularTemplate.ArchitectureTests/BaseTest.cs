...
///   - e.g., ModularTemplate.Common.Domain
///   - e.g., ModularTemplate.Common.Application
///
/// Module layers must follow: {Prefix}.Modules.{ModuleName}.{Layer}
///   - e.g., ModularTemplate.Modules.Sample.Domain
///   - e.g., ModularTemplate.Modules.Orders.Application
///
...
public abstract class BaseTest
{
    ...
    /// <summary>
    /// Gets all module root namespaces (e.g., ["ModularTemplate.Modules.Sample", "ModularTemplate.Modules.Orders"]).
    /// </summary>
