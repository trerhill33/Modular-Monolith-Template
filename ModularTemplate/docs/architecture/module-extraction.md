...
|-------------------|------------------------|
| `src/Modules/Orders/ModularTemplate.Modules.Orders.Domain/` | `src/Orders.Domain/` |
| `src/Modules/Orders/ModularTemplate.Modules.Orders.Application/` | `src/Orders.Application/` |
| `src/Modules/Orders/ModularTemplate.Modules.Orders.Infrastructure/` | `src/Orders.Infrastructure/` |
| `src/Modules/Orders/ModularTemplate.Modules.Orders.Presentation/` | `src/Orders.Presentation/` |
| `src/Modules/Orders/ModularTemplate.Modules.Orders.IntegrationEvents/` | `src/Orders.IntegrationEvents/` |
| `src/API/ModularTemplate.Api.Orders/` | `src/Orders.Api/` |
...
```bash
cp -r ModularTemplate/src/Common/* orders-service/src/Common/
```
...
find src -name "*.cs" -exec sed -i 's/ModularTemplate.Modules.Orders/Orders/g' {} \;
```
...
dotnet sln ModularTemplate.Api.sln remove src/Modules/Orders/**/*.csproj
dotnet sln ModularTemplate.Api.sln remove src/API/ModularTemplate.Api.Orders/*.csproj

# Delete module folders
rm -rf src/Modules/Orders
rm -rf src/API/ModularTemplate.Api.Orders
```
