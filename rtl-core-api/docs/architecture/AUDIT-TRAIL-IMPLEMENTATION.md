...
**Location:** `src/Common/Rtl.Core.Infrastructure/Auditing/`
...
**File:** `src/Common/Rtl.Core.Domain/Auditing/IAuditable.cs`
...
**File:** `src/Common/Rtl.Core.Domain/Auditing/SensitiveDataAttribute.cs`
...
**File:** `src/Common/Rtl.Core.Infrastructure/Auditing/AuditLog.cs`
...
**File:** `src/Common/Rtl.Core.Infrastructure/Auditing/AuditLogConfiguration.cs`
...
**File:** `src/Common/Rtl.Core.Infrastructure/Persistence/ModuleDbContext.cs`
...
**File:** `src/Common/Rtl.Core.Domain/Entities/IAuditableEntity.cs`
...
**File:** `src/Common/Rtl.Core.Infrastructure/Auditing/AuditEntry.cs`
...
**File:** `src/Common/Rtl.Core.Infrastructure/Auditing/AuditTrailInterceptor.cs`
...
**File:** `src/Common/Rtl.Core.Infrastructure/Persistence/ModuleDbContextExtensions.cs`
...
**File:** `src/Common/Rtl.Core.Infrastructure/InfrastructureConfiguration.cs`
...
**File:** `src/Common/Rtl.Core.Application/Auditing/IAuditContext.cs`
...
**File:** `src/Common/Rtl.Core.Infrastructure/Auditing/AuditContext.cs`
...
**File:** `src/Common/Rtl.Core.Application/Auditing/IAuditMaskingService.cs`
...
**File:** `src/Common/Rtl.Core.Infrastructure/Auditing/AuditMaskingService.cs`
...
**File:** `src/Common/Rtl.Core.Application/Auditing/IAuditLogRepository.cs`
...
**File:** `src/Common/Rtl.Core.Infrastructure/Auditing/AuditLogRepository.cs`
...
```bash
# Sales module
dotnet ef migrations add AddAuditLogs -p src/Modules/Sales/Rtl.Module.Sales.Infrastructure -s src/API/Rtl.Core.Api

# Orders module
dotnet ef migrations add AddAuditLogs -p src/Modules/Orders/Rtl.Module.Orders.Infrastructure -s src/API/Rtl.Core.Api
```

#### Task 6.2: Create Unit Tests

**File:** `test/Rtl.Core.Infrastructure.Tests/Auditing/AuditTrailInterceptorTests.cs`
...
- **Current Interceptors:** `X:\SES\modular-monolith-repo\Rtl.Core\src\Common\Rtl.Core.Infrastructure\Auditing\`
