...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rtl.Module.SampleOrders.Domain.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Rtl.Module.SampleOrders.Domain.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Rtl.Module.SampleOrders.Domain.Orders.OrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Rtl.Module.SampleOrders.Domain.ProductsCache.ProductCache", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Rtl.Module.SampleOrders.Domain.Customers.Customer", b =>
                {
                    b.OwnsOne("Rtl.Module.SampleOrders.Domain.ValueObjects.Email", "Email", b1 =>
                        {
            ...
            modelBuilder.Entity("Rtl.Module.SampleOrders.Domain.Orders.OrderLine", b =>
                {
                    b.HasOne("Rtl.Module.SampleOrders.Domain.Orders.Order", null)
                        .WithMany("Lines")
